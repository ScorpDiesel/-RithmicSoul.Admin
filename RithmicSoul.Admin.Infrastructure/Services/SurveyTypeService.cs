...
public class SurveyTypeService : IService<SurveyTypeDto>
{
    ...
    public async Task<IEnumerable<SurveyTypeDto>> GetAsync(Expression<Func<SurveyTypeDto, bool>> expression)
    {
        ...
        var response = await _httpClient.PostAsync("v3/SurveyTypes", content);
    ...
    public async Task<IEnumerable<SurveyTypeDto>> GetAllFromViewAsync()
    {
        throw new NotImplementedException();
    }

    public async Task<IEnumerable<SurveyTypeDto>> GetFromViewAsync(Expression<Func<SurveyTypeDto, bool>> expression)
    {
        throw new NotImplementedException();
    }
}